...
class TeacherWidget {
  ...
  static drawer(TeacherViewModel dashboardViewModel) => Container(
  ...
  static tabDrawer(TeacherViewModel dashboardViewModel) => Container(
    padding: EdgeInsets.symmetric(vertical: 20),
    decoration: BoxDecoration(
      gradient: LinearGradient(colors: [Color(0xff9D5DE6), Color(0xffF78C59)]),
    ),
  ...
  static bottomNavBar(TeacherViewModel dashboardViewModel) => Container(
    decoration: BoxDecoration(
      gradient: LinearGradient(colors: [Color(0xff9D5DE6), Color(0xffF78C59)]),
    ),
    child: NavigationBar(
