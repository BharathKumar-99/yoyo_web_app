...
Widget getDisabledPhrase(PhraseModel row, PhrasesViewModel provider) =>
    GestureDetector(
      onTap: () {
        ...
        final availableSchools = provider.commonViewModel.schools
                  ...
                  actions: [
                    ...
                    ElevatedButton(
                      onPressed: selectedSchools.isEmpty
                          ? null
                          : () async {
                              final ids = selectedSchools
                                  .map((e) => e.id!)
                                  .toList();

                              await provider.disablePhrase(row.id!, ids);
