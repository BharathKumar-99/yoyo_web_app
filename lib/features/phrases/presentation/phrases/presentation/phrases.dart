      ...
      builder: (context, viewModel, child) =>
          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                  SizedBox(height: 15),
                  if (viewModel.commonViewModel.teacher?.teacher?.isEmpty ??
                      true)
                    viewModel.isloading
                        ? YoyoWaiting()
                        : (viewModel
                              ...
                              children: [
                                                ...
                                                decoration: InputDecoration(
                                                  hintText:
                                                      viewModel
                                                          ...
                                                          null
                                                      ? 'enter phrase here'
                                                      : 'enter phrase ${viewModel.commonViewModel.selectedClass?.language?.language} here',
                                                  hintStyle:
                                                      GoogleFonts.poppins(
                                                        fontSize: 20,
                                                        fontStyle:
                                ...
                                Padding(
                                  ...
                                  child: GestureDetector(
                                    onTap: () => viewModel.addPhrases(context),
                                    child: Container(
                                      height: 60,
